...
Array *UnionOperation(Array *arr1,Array *arr2) {
    int i, j, k;
    i = j = k = 0;
...
Array *IntersectionOperation(Array *arr1,Array *arr2) {
    int i, j, k;
    i = j = k = 0;
    Array *arr3 = (Array *)malloc(sizeof(Array *));
    while (i < arr1->length && j < arr2->length) {
...
Array *DifferenceOperation(Array *arr1, Array *arr2) {
    int i, j, k;
    i = j = k = 0;
    Array *arr3 = (Array *)malloc(sizeof(Array *));
    while (i < arr1->length && j < arr2->length) {
...
int main() {
    Array arr1 = {{1, 3, 5, 7, 8}, 10, 5};
    Array arr2 = {{2, 3, 5, 8, 10}, 10, 5};
    Array *arr3,*arr6,*arr5;
    Display(arr1);
    Display(arr2);
